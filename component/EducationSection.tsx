        ...
        .map((el, idx) => {
          return (
            <div className={styles.school_wrapper} key={idx}>
              ...
              <div className={`${common.key_value} ${styles.type}`}>
                <span>학교 종류</span>
                <span>{el.type}</span>
              </div>
              <div className={`${common.key_value} ${styles.admission}`}>
                <span>입학일</span>
                <span>{el.admissionDate}</span>
              </div>
              <div className={`${common.key_value} ${styles.graduation}`}>
                <span>졸업일</span>
              ...
              <div className={`${common.key_value} ${styles.describe}`}>
                <span>설명</span>
